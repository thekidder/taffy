...
OPTION(SORE_DYNAMIC_LIB "Link dynamically instead of statically" OFF)
...
FIND_LIBRARY(SORE_LIBRARY_STATIC_RELEASE
  NAMES sore_s
  PATHS
  PATH_SUFFIXES lib64 lib
  /usr/local
...
FIND_LIBRARY(SORE_LIBRARY_STATIC_DEBUG
  NAMES sore_s_debug
  PATHS
  PATH_SUFFIXES lib64 lib
  /usr/local
...
IF(SORE_DYNAMIC_LIB)
  ...
  ENDIF()
ELSE()
  IF(SORE_LIBRARY_STATIC_DEBUG AND NOT SORE_LIBRARY_STATIC_RELEASE)
    SET(SORE_LIBRARY ${SORE_LIBRARY_STATIC_DEBUG})
  ELSEIF(SORE_LIBRARY_STATIC_RELEASE AND NOT SORE_LIBRARY_STATIC_DEBUG)
    SET(SORE_LIBRARY ${SORE_LIBRARY_STATIC_RELEASE})
  ELSE()
    IF (CMAKE_CONFIGURATION_TYPES OR CMAKE_BUILD_TYPE)
      SET(SORE_LIBRARY optimized ${SORE_LIBRARY_STATIC_RELEASE} debug ${SORE_LIBRARY_STATIC_DEBUG})
    ELSE()
      # if there are no configuration types and CMAKE_BUILD_TYPE has no value
      # then just use the release libraries
      SET(SORE_LIBRARY ${SORE_LIBRARY_STATIC_RELEASE})
