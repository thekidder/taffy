...
KISS_Spectrum::KISS_Spectrum(size_t fft_size, int sample_rate) 
    : Spectrum(fft_size, sample_rate), timedata(fft_size), freqdata_left(fft_size), freqdata_right(fft_size)
{
