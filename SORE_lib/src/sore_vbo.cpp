...
*/
//$Id: vbo.cpp 23 2008-10-08 02:14:59Z me $
...
namespace SORE_Graphics
{
				...
				void VBO::DrawElements(unsigned int numTris, unsigned int triOffset)
				{
								glDrawRangeElements(GL_TRIANGLES, triOffset*3, indices.size(), numTris*3, GL_UNSIGNED_SHORT, 0);
				}
